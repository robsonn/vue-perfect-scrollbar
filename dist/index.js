module.exports = (function (t) {
    ...
    function (t, e, r) {
        ...
        e.default = {
            ...
            props: { settings: { default: void 0 }, tagname: { type: String, default: "section" } },
            data: function () {
                return { ps: null };
            },
            methods: {
    ...
    function (t, e, r) {
        ...
        function d(t, e, r, i, n) {
            ...
            (t.reach[a] = null),
                ...
                e && (d.dispatchEvent(p("ps-scroll-" + a)), e < 0 ? d.dispatchEvent(p("ps-scroll-" + c)) : e > 0 && d.dispatchEvent(p("ps-scroll-" + h)), i && u(t, a)),
                t.reach[a] && (e || n) && d.dispatchEvent(p("ps-" + a + "-reach-" + t.reach[a]));
        }
        function f(t) {
        ...
        function m(t, e) {
            ...
            e.isScrollbarYUsingRight
                ? e.isRtl
                    ? (o.right = e.contentWidth - (e.negativeScrollAdjustment + t.scrollLeft) - e.scrollbarYRight - e.scrollbarYOuterWidth)
                ...
                n(e.scrollbarX, { left: e.scrollbarXLeft, width: e.scrollbarXWidth - e.railBorderXWidth }),
                n(e.scrollbarY, { top: e.scrollbarYTop, height: e.scrollbarYHeight - e.railBorderYWidth });
        }
        function y(t, e) {
            function r(e) {
            ...
            t.event.bind(t[a], "mousedown", function (e) {
                (v = b[p]),
                    (g = e[l]),
                    (m = (t[o] - t[n]) / (t[s] - t[u])),
                    t.event.bind(t.ownerDocument, "mousemove", r),
                    t.event.once(t.ownerDocument, "mouseup", i),
                    t[f].classList.add(Y.state.clicking),
                    e.stopPropagation(),
                    e.preventDefault();
            });
        }
        ...
        (X.prototype.bind = function (t, e) {
            void 0 === this.handlers[t] && (this.handlers[t] = []), this.handlers[t].push(e), this.element.addEventListener(t, e, !1, { passive: true });
        }),
        ...
        var L = function (t, e, r, i, n) {
            ...
            T = function (t) {
                ...
                (t.containerWidth = e.clientWidth),
                    ...
                    e.contains(t.scrollbarXRail) ||
                        (a(e, Y.element.rail("x")).forEach(function (t) {
                            return s(t);
                        }),
                        e.appendChild(t.scrollbarXRail)),
                    e.contains(t.scrollbarYRail) ||
                        (a(e, Y.element.rail("y")).forEach(function (t) {
                            return s(t);
                        }),
                    ...
                    !t.settings.suppressScrollX && t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth
                        ? ((t.scrollbarXActive = !0),
                          ...
                          (t.scrollbarXLeft = f(((t.negativeScrollAdjustment + e.scrollLeft) * (t.railXWidth - t.scrollbarXWidth)) / (t.contentWidth - t.containerWidth))))
                    ...
                    !t.settings.suppressScrollY && t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight
                        ? ((t.scrollbarYActive = !0),
                          ...
                          (t.scrollbarYTop = f((r * (t.railYHeight - t.scrollbarYHeight)) / (t.contentHeight - t.containerHeight))))
                    ...
                    if (!n(i.target, s, a)) {
                        ...
                        t.settings.useBothWheelAxes
                            ? t.scrollbarYActive && !t.scrollbarXActive
                                ? (a ? (l.scrollTop -= a * t.settings.wheelSpeed) : (l.scrollTop += s * t.settings.wheelSpeed), (c = !0))
                                : t.scrollbarXActive && !t.scrollbarYActive && (s ? (l.scrollLeft += s * t.settings.wheelSpeed) : (l.scrollLeft -= a * t.settings.wheelSpeed), (c = !0))
                            : ((l.scrollTop -= a * t.settings.wheelSpeed), (l.scrollLeft += s * t.settings.wheelSpeed)),
                            T(t),
                            (c = c || e(s, a)),
            ...
            k = function (t) {
                        ...
                        (f = setInterval(function () {
                            return t.isInitialized
                                ...
                                ? Math.abs(d.x) < 0.01 && Math.abs(d.y) < 0.01
                                    ? void clearInterval(f)
                                    : (r(30 * d.x, 30 * d.y), (d.x *= 0.8), void (d.y *= 0.8))
                                : void clearInterval(f);
                        }, 10)));
                }
                if (R.supportsTouch || R.supportsIePointer) {
                    var h = t.element,
                        ...
                        f = null;
                    R.supportsTouch
                        ? (t.event.bind(h, "touchstart", l), t.event.bind(h, "touchmove", a), t.event.bind(h, "touchend", c))
                        : R.supportsIePointer &&
                          (window.PointerEvent
                              ? (t.event.bind(h, "pointerdown", l), t.event.bind(h, "pointermove", a), t.event.bind(h, "pointerup", c))
            ...
            P = { "click-rail": S, "drag-thumb": H, keyboard: E, wheel: M, touch: k },
            C = function (t, e) {
                var r = this;
                ...
                (this.isRtl = "rtl" === i(t).direction),
                    ...
                    (this.scrollbarXRail = o(Y.element.rail("x"))),
                    t.appendChild(this.scrollbarXRail),
                    (this.scrollbarX = o(Y.element.thumb("x"))),
                ...
                (this.scrollbarXBottom = parseInt(c.bottom, 10)),
                    ...
                    (this.scrollbarYRail = o(Y.element.rail("y"))),
                    t.appendChild(this.scrollbarYRail),
                    (this.scrollbarY = o(Y.element.thumb("y"))),
    ...
    function (t, e) {
        ...
        function n(t, e) {
            var r = d(),
                i = v[v.length - 1];
            if ("top" === t.insertAt) i ? (i.nextSibling ? r.insertBefore(e, i.nextSibling) : r.appendChild(e)) : r.insertBefore(e, r.firstChild), v.push(e);
            else {
        ...
        function a(t, e, r, i) {
            var n = r ? "" : i.css;
            if (t.styleSheet) t.styleSheet.cssText = g(e, n);
            else {
